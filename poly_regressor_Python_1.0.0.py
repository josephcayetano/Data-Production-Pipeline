...
# set an specific experiment name
experiment_name = "FlightDelays"  
...
with mlflow.start_run(experiment_id=experiment_id, run_name = "Final Model - Test Data"):
    ...
    mlflow.sklearn.log_model(ridgereg, "final_model")
